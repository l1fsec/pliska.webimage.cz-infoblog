...
<body class="subpage">
	<a class=" weatherwidget-io" href="https://forecast7.com/cs/50d6614d05/usti-nad-labem/" data-label_1="Ústí nad Labem" data-label_2="Počasí" data-font="Open Sans" data-icons="Climacons Animated" data-theme="original" data-basecolor="#2424ad" data-cloudfill="#1891e3">Ústí nad Labem Počasí</a>
	<!-- Header -->
	...
	<nav id="menu">
		<ul class="links">
			<li><a href="articles/about.html" class="icon fa-question"> Zájmy</a></li>
			<li><a href="profile.php" class="icon  fa-user"> Profil</a></li>
			<li><a href="logout.php" class="icon fa-sign-out"> Odhlásit se</a></li>
		</ul>
	</nav>
	<!--Content-->
	<section id="post" class="wrapper bg-img" data-bg="../../images/banner8.jpg">
		<div class="inner">
			<article class="box">
				<header>
